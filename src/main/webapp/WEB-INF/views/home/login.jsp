...
<body
	style="background-image: url(<c:url value="/statics/image/background/loginbanner.jpg"/>); background-size: 100%">
	<div style="margin: 20px auto">
		<div style="margin: 100px auto; margin-bottom: 40px" align="center">
			<h1 style="font-size: 60px">欢迎登录转合二手商城</h1>
		</div>
	</div>
	...
	<div class="container" style="position: relative; margin: 80px auto;">
		<div class="col-md-6 login-back"
			...
			<a href="<c:url value="/admin/adminLogin"/>">管理员登录</a> <a
				style="float: right" href="<c:url value="/"/>">返回首页</a>
