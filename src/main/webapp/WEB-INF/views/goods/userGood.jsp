		...
		<div class="col-md-9" style="float: left">
			<div class="col-md-12 r1"
				...
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: white; font-size: 20px">用户信息</B>
				</div>
			</div>
			...
			<div class="col-md-12 r2"
				...
				<div class="col-md-2" style="padding-left: 0px; padding-right: 0px;">
					<img src="<c:url value="${user.getPhotoUrl()}"/>"
				...
				<div class="col-md-10">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<p style="color: #666666; height: 20px">${user.getName()}</p>
							<p style="color: #666666; height: 20px">${user.getGender()}</p>
						</div>
						<div class="col-md-2">
							<p style="color: #666666; height: 20px">
								<b>手机号：</b>
						...
						<div class="col-md-3">
							<p style="color: #666666; height: 20px;width: 30px">${user.getMobile()}</p>
							<p style="color: #666666; height: 20px;width: 30px">${user.getEmail()}</p>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-3" style="padding-left: 0;width: auto">
							<p style="color: #666666; height: 20px">${user.getAddress()}</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12 r2" style="background-color: white;">
				<div class="col-md-12"
		...
		<div id="re-bar" class="col-md-3 r"
			...
			<div class="col-md-12"
				...
				<c:forEach var="Good" items="${goods}">
					<a target="_blank"
						href="<c:url value="/goods/goodInfo?goodId=${Good.id}"/>">
