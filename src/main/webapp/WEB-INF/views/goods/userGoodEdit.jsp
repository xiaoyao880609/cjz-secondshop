...
<body>
		...
		<div class="col-md-9">
			...
			<div class="col-md-12 r2"
				...
				<div class="col-md-12 r"
					...
					<div id="goodImg" class="col-md-12" style="padding: 0px;">
						<div class="col-md-4" style="padding: 15px" align="center">
							<div style="width: 100%; height: 230px;">
								<img src="${good.photoUrl}" height="100%"
									width="100%">
							</div>
						</div>
						...
						<c:forEach var="goodImage" items="${goodImages}">
							<div class="col-md-4" style="padding: 15px" align="center">
								<div style="width: 100%; height: 230px;">
									<img src="${goodImage.url}" height="100%"
										width="100%">
								</div>
							</div>
						</c:forEach>
					...
					<form action="userGoodEdit/updateImage"
    ...
    $(function () {
		...
		$.getJSON("/cjz/type/secondType/" + goodType, function (data) {
            console.log(data);
