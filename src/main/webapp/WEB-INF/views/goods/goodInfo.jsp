...
<body>
	...
	<div class="container">
		<div class="col-md-9">
			<div class="col-md-12 r1"
				...
				<div class="col-md-4"
					...
					<B
						style="display: ${collect == 1 ? 'none':''}; color: black; font-size: 18px;margin-top: 3px; float: right">已收藏</B>
					<a onclick="collect()" class="btn"
						style="display: ${collect == 2 ? 'none':''}; float: right; margin-top: 0px; padding: 2px">
						<B style="color: black; font-size: 18px;">收藏</B>
					</a>
				</div>
			</div>
			
			<div class="col-md-12 r2"
				style="background-color: #f9f9f9; padding: 0 0 15px;">
				<div class="col-md-12" style="margin-top: 40px;">
					<div class="col-md-7" align="center">
						<div style="width: 85%;height: 50%;" align="center">
							<img src="${goodInfo.photoUrl}" width="80%" height="50%"
								id="img-a" alt="图片">
						</div>
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<img src="${goodInfo.photoUrl}" height="50%"
											 width="85%" alt="图片">
									</div>
						...
						<div class="col-md-12" style="padding: 0px">
							...
							<c:choose>
								<c:when test="${goodInfo.statusId == 1}">
									...
									<a
										style="display: ${sessionScope.user.id == goodInfo.goodUser.id ? '':'none'}"
										href="<c:url value="/goods/userGoodEdit?goodId=${goodInfo.id}"/>">
			...
			<div class="col-md-12 r2"
				...
				<div class="col-md-12" style="margin-top: 20px">
					<p style="color: black;">&emsp;&emsp;${goodInfo.describe}</p>
				</div>
			</div>
			...
			<div class="col-md-12 r1"
				style="background-color: #00a0e9; height: 40px; margin-top: 20px;">
				<div class="col-md-6" style="margin-top: 5px">
					<B style="color: white; font-size: 20px">留言板块</B>
				</div>
			</div>
			...
			<div class="col-md-12 r2"
				...
				<c:choose>
					<c:when test="${reviews.size() == 0}">
						<div class="col-md-12 r"
							...
							<p></p>
							<p style="color: black; font-size: 20px" align="center">留言板为空，赶快发表你的留言！</p>
						</div>
					</c:when>
					...
					<c:otherwise>
						<c:forEach var="review" items="${reviews}">
							<div class="col-md-12 r"
								...
								<p></p>
								<P style="color: #999999">时间：${review.uploadDate}</P>
								...
								<div class="col-md-10" style="margin-left: 50px">
									<c:forEach var="reply" items="${review.replys}">
										<P style="color: #999999">时间：${reply.uploadDate}</P>
								...
								<div id="${review.id}" class="col-md-12"
									...
									<form action="<c:url value="/goods/goodInfo"/>" method="post">
										<div class="col-sm-10">
				...
				<c:choose>
					...
					<c:otherwise>
						<div class="col-md-12" style="margin-bottom: 15px">
							<p></p>
							<p style="color: red; font-size: 20px" align="center">你需要先登陆后才能发表留言！</p>
						</div>
					</c:otherwise>
				</c:choose>
			</div>
		...
		<div class="col-md-3 r"
			...
			<div class="col-md-12 r"
				...
				<B style="font-size: 20px; color: white">相关推荐</B>
			</div>
			...
			<div class="col-md-12"
				...
				<c:forEach var="good" items="${goods}">
					<a target="_blank" href="?goodId=${good.id}">
		...
		$.ajax({
            ...
            success:function (data) {
                if (data === false){
                    ...
                    alert("收藏成功！");
                    $(window).attr('location','/cjz/goods/goodInfo?goodId=${goodInfo.id}');
                }
            }
        })
    }
    ...
    function replyFun(replyId, replyToUser) {
        if (${sessionScope.user != null}) {
			...
			const toUser = "回复 " + replyToUser;
			const replyToUserId = "#" + replyId + "replyToUser";
			const replyText = "#" + replyId + "replyText";
    ...
    function getBuy() {
        if (${sessionScope.user == null}) {
			...
			location.href = "/cjz/goods/pay?goodId=${goodInfo.id}"
			}
    }
	</script>
