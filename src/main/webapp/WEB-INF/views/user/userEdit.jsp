					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="review" items="${reviews}">
								<a target="_blank"
									href="/cjz/review?goodId=${review.goodId}&reviewId=${review.id}">
					...
					<c:choose>
						...
						<c:otherwise>
							<c:forEach var="reply" items="${replies}">
								<a target="_blank"
									href="/cjz/reply?reviewId=${reply.reviewId}&replyId=${reply.id}">
									<div class="col-md-12 rev"
										style="padding-left: 0px; padding-right: 0px; margin-bottom: 5px;">
										<div class="col-md-11">
											<p></p>
						...
						<c:choose>
							...
							<c:otherwise>
								<c:forEach var="sellGood" items="${sellGoods}">
									<a href="/cjz/sellerInfo?orderId=${sellGood.id}">
										<div class="col-md-12 rev"
